  ...
  <a class="navbar-brand" href="#">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/product">Shop</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container mt-5">
        ...
        <div class="row my-4 ms-5">
            <div class="col-lg-4 mb-3">
                ...
                <img src="https://mcdonalds.co.nz/sites/mcdonalds.co.nz/files/product-McFlurry_cookie-mobile.png" class="card-img-top" alt="..." style="max-height: 400px;">
                    <div class="card-body">
                        <h5 class="card-title">Mcflurry Oreo</h5>
                        <p class="card-text">Rp11.867</p>
            ...
            <div class="col-lg-4 mb-3">
            <div class="card" style="width: 18rem;">
                <img src="https://socratesdistributors.com.au/wp-content/uploads/2023/03/CKG33CC-2-2-1.jpg" class="card-img-top" alt="..." style="max-height: 400px;">
                    <div class="card-body">
                        <h5 class="card-title">Coke</h5>
                        <p class="card-text">Rp24.803</p>
            ...
            <div class="col-lg-4 mb-3">
            <div class="card" style="width: 18rem;">
                <img src="https://goldenlamian.com/assets/img/items/lamian/menu-lamian-extraspicybeef.png" class="card-img-top" alt="..." style="max-height: 400px;">
                    <div class="card-body">
                        <h5 class="card-title">Ramen</h5>
                        <p class="card-text">Rp56.754</p>
                        <a href="" class="btn btn-outline-primary w-100">Order now</a>
                    </div>
                </div>
            </div>
...
<footer class="mt-5 bg-primary bg-opacity-25 text-center" style="height:50px;">
    <p>
        Created by <a href="https://www.instagram.com/ravaakk/?hl=id" style="text-decoration:none; color:indigo;" target="_blank">Rava Athallah Kietha</a>
    </p>
</footer>
<!-- end footer -->
